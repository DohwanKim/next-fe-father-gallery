...
const UserFooter = () => {
  return (
    <footer
      className={
        'flex container text-xs justify-between h-[60px] gap-y-2 items-center flex-wrap border-t py-4 text-foreground/60'
      }
    >
      <div className={'flex gap-x-5 gap-y-2 mr-5 flex-wrap'}>
        ...
        <a href={'tel:+82 10 3831 5338'} className={'flex gap-1 items-center'}>
