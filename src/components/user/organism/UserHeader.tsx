...
const UserHeader = () => {
  ...
  return (
    <header
      id="user-header"
      ref={headerRef}
      className={`sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 transform transition-transform duration-300 ease-in-out ${
        isHeaderHideByScroll ? 'translate-y-[-100%]' : 'translate-y-0'
      }`}
    >
      <div
        className={
